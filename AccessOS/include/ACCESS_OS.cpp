...
public:
  ...
  void setValues(int wantConfig, int val);
...
/*------------------------------------------------------------------------------------------------------
[EXPERIMENTAL] setValues > Sets param to asked value from configuration[]
------------------------------------------------------------------------------------------------------*/
void ACCESS_OS::setValues(int wantConfig, int val) 
{
  if (!(val > maxMenus) && !(wantConfig > maxMenus)) 
  {
    configuration[wantConfig] = val;
  }
}
